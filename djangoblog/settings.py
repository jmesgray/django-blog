...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # this line is already done for you, unlike in vs code.
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / '', # need to add in your global static file here. this is where you left off
    }
}
